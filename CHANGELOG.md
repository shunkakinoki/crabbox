...
- Let coordinator admin commands use an existing authorized GitHub session when no explicit admin token is configured, preserving explicit-token precedence and server-side authorization.
